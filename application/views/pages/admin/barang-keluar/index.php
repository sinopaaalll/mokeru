                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-button">
                            <a href="<?= base_url('admin/barang_keluar/create') ?>" class="btn btn-primary">Tambah</a>
                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($barang_keluar as $item) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $item->ket ?></td>
                                                        <td>
                                                            <a href="<?= base_url('admin/barang_keluar/destroy/' . $item->id) ?>" class="btn btn-default btn-hapus"><span class="fa fa-trash"></span> Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>

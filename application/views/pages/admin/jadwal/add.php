                                            ...
                                            <div class="col-sm-12 col-md-6 ">
                                                <form action="" method="post" autocomplete="off">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="petugas[]" id="petugas" class="form-control select2 <?= form_error('petugas[]') ? "is-invalid" : "" ?>" multiple="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="hari" id="hari" class="form-control <?= form_error('hari') ? "is-invalid" : "" ?>">
                                                            ...
                                                            <?php foreach ($days as $key => $day) { ?>
                                                                <option value="<?= $key + 1 ?>" <?= (set_value('hari') == $key + 1) ? 'selected' : '' ?>><?= $day ?></option>
                                                            <?php } ?>
                                                        </select>

                                            ...
                                            <tbody>
                                                ...
                                                foreach ($user as $item) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('admin/user/edit/' . $item->id) ?>" class="btn btn-default"><span class="fa fa-edit"></span> Edit</a>
                                                            <a href="<?= base_url('admin/user/destroy/' . $item->id) ?>" class="btn btn-default btn-hapus"><span class="fa fa-trash"></span> Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>

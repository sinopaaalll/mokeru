                                            ...
                                            <tbody>
                                                ...
                                                foreach ($ruangan as $item) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $item->nama ?></td>
                                                        <td>
                                                            <a href="<?= base_url('admin/ruangan/edit/' . $item->id) ?>" class="btn btn-default"><span class="fa fa-edit"></span></a>
                                                            <a href="<?= base_url('admin/ruangan/destroy/' . $item->id) ?>" class="btn btn-default btn-hapus"><span class="fa fa-trash"></span></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>

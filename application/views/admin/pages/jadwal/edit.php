                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <form action="" method="post" autocomplete="off">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="petugas" id="petugas" class="form-control select2 <?= form_error('petugas') ? "is-invalid" : "" ?>">
                                                            ...
                                                            <?php foreach ($petugas as $p) { ?>
                                                                <option value="<?= $p->id ?>" <?= $jadwal->petugas_id == $p->id ? "selected" : "" ?>><?= $p->nik ?> &mdash; <?= $p->nama ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="hari" id="hari" class="form-control <?= form_error('hari') ? "is-invalid" : "" ?>" placeholder="Ketikkan hari" value="<?= $jadwal->hari ?>">

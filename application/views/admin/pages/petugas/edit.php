                                            ...
                                            <div class="col-sm-12 col-md-6 ">
                                                <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="telp" id="telp" class="form-control <?= form_error('telp') ? "is-invalid" : "" ?>" placeholder="Ketikkan telpon" value="<?= $petugas->telp ?>">
                                                        <?= form_error('telp', '<div class="invalid-feedback">', '</div>') ?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="email">Email *</label>
                                                        <input type="email" name="email" id="email" class="form-control <?= form_error('email') ? "is-invalid" : "" ?>" placeholder="Ketikkan email" value="<?= $petugas->email ?>">

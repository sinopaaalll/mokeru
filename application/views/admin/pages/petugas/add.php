                                            ...
                                            <div class="col-sm-12 col-md-6 ">
                                                <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama" id="nama" class="form-control <?= form_error('nama') ? "is-invalid" : "" ?>" placeholder="Ketikkan nama petugas" value="<?= set_value('nama') ?>" autofocus>
                                                        <?= form_error('nama', '<div class="invalid-feedback">', '</div>') ?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="nik">NIK *</label>
                                                        <input type="text" name="nik" id="nik" class="form-control <?= form_error('nik') ? "is-invalid" : "" ?>" placeholder="Ketikkan nomor induk karyawan" value="<?= set_value('nik') ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="telp" id="telp" class="form-control <?= form_error('telp') ? "is-invalid" : "" ?>" placeholder="Ketikkan telpon" value="<?= set_value('telp') ?>">
                                                        <?= form_error('telp', '<div class="invalid-feedback">', '</div>') ?>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="email">Email *</label>
                                                        <input type="email" name="email" id="email" class="form-control <?= form_error('email') ? "is-invalid" : "" ?>" placeholder="Ketikkan email" value="<?= set_value('email') ?>">

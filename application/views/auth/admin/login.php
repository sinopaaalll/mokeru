...
<head>
    ...
    <title>MoKeRu &mdash; Login Admin</title>
                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4 class="mx-auto">Login Admin</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="">
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <input type="text" name="username" id="username" class="form-control <?= form_error('username') ? "is-invalid" : "" ?>" value="<?= set_value('username') ?>" placeholder="Ketikkan username" autofocus>
                        ...
                        <div class="mt-5 text-muted text-center">
                            You are not an admin? <a href="<?= base_url('home') ?>">Back</a>
                        </div>
